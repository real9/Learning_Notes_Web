...
import LogParsing from "../views/log/pages/LogParsing";
import ModelTraining from "../views/log/pages/ModelTraining";
import LogDetection from "../views/log/pages/LogDetection";
